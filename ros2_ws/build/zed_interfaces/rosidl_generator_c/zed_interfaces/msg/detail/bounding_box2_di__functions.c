...
{
  zed_interfaces__msg__BoundingBox2Di * msg = (zed_interfaces__msg__BoundingBox2Di *)malloc(sizeof(zed_interfaces__msg__BoundingBox2Di));
  if (!msg) {
    return NULL;
  }
...
zed_interfaces__msg__BoundingBox2Di__Sequence__init(zed_interfaces__msg__BoundingBox2Di__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (zed_interfaces__msg__BoundingBox2Di *)calloc(size, sizeof(zed_interfaces__msg__BoundingBox2Di));
    if (!data) {
      return false;
    }
...
{
  zed_interfaces__msg__BoundingBox2Di__Sequence * array = (zed_interfaces__msg__BoundingBox2Di__Sequence *)malloc(sizeof(zed_interfaces__msg__BoundingBox2Di__Sequence));
  if (!array) {
    return NULL;
  }
