...
#ifndef VELODYNE_MSGS__MSG__VELODYNE_SCAN__STRUCT_HPP_
#define VELODYNE_MSGS__MSG__VELODYNE_SCAN__STRUCT_HPP_
...
struct VelodyneScan_
{
  ...
  explicit VelodyneScan_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit VelodyneScan_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _header_type header;
  using _packets_type =
    std::vector<velodyne_msgs::msg::VelodynePacket_<ContainerAllocator>, typename ContainerAllocator::template rebind<velodyne_msgs::msg::VelodynePacket_<ContainerAllocator>>::other>;
  ...
  Type & set__packets(
    const std::vector<velodyne_msgs::msg::VelodynePacket_<ContainerAllocator>, typename ContainerAllocator::template rebind<velodyne_msgs::msg::VelodynePacket_<ContainerAllocator>>::other> & _arg)
  {
    this->packets = _arg;
    return *this;
  }
...
#endif  // VELODYNE_MSGS__MSG__VELODYNE_SCAN__STRUCT_HPP_
